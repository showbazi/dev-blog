...
const ModalHeader = styled.div`
    ...
    height: 2.75rem;
    display: flex;
    border-bottom: ${prop => prop.borderBottom === "1" ? "1px solid rgba(97, 123, 255, 0.7)" : null};
`;
    ...
    return (
        <ModalContainer>
            ...
            <ModalContent theme={theme}>
                ...
                {!!searchResults && <SearchResults searchResults={searchResults} theme={theme} handleModalState={handleModalState}/>}
